#Title : "Food Delivery Case Study"
...
#From the mean values of each variable of 3 cluster we can see that clusters have mainly transaction frequecy and AOV, while delivery time and average distance don't show much varaince
...
# 57% Users have not transacted in last 4 weeks but the size of that cluster 3076 (3rd cluster) dosen't resonate with that. So for better clustering of active users lets try to build a cluster for only them by removing Users who didn't interacted in last 4 Week
